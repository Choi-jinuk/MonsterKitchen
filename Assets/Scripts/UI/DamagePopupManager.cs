...
namespace MonsterKitchen.UI
{
    ...
    public class DamagePopupManager : MonoBehaviour
    {
        ...
        void Start()
        {
            var prefab = AssetLoadManager.Instance?.Load<DamagePopup>(AssetKeys.PrefabDamagePopup);
            if (prefab == null)
            {
                Debug.LogError("[DamagePopupManager] DamagePopup 프리팹을 AssetManifest에서 찾을 수 없습니다. 키: " + AssetKeys.PrefabDamagePopup);
                return;
            }
