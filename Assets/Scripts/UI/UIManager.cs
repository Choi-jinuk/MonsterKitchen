...
namespace MonsterKitchen.UI
{
    ...
    public class UIManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            var hudPrefab = AssetLoadManager.Instance?.Load<GameObject>(AssetKeys.PrefabHud);
            if (hudPrefab != null)
                Instantiate(hudPrefab, transform);
            else
                Debug.LogWarning("[UIManager] HUD 프리팹을 AssetManifest에서 찾을 수 없습니다. 키: " + AssetKeys.PrefabHud);
        }
