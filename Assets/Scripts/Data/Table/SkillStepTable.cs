...
namespace MonsterKitchen.Data
{
    ...
    {
        [Header("Identity")]
        [Tooltip("스킬 스텝 uint ID. DataTable 키. 예: 11001")]
        public uint Id;

        [Tooltip("스킬 고유 문자열 ID. 예: SKL_001")]
        ...
        [Header("Projectile Asset")]
        [Tooltip("투사체 프리팹 주소. 형식: prefab/projectile/{skillId}\n" +
                 "missileSpeed > 0 일 때만 유효. AssetManifest 에 등록된 키.")]
    ...
    [Serializable]
    public class SkillStepTable : DataTable<SkillData> { }
}
